...
@section('page-title', 'Ver Escala - ' . $escala->IdEscala)
    ...
    <div class="material-card shadow-xl rounded-lg max-w-3xl mx-auto border-t-4 border-purple-500">
        <div class="p-6">
            ...
            <h2 class="text-2xl font-semibold text-gray-700 mb-6 border-b pb-3 flex items-center">
                Información de Parada Técnica - Escala **#{{ $escala->IdEscala }}**
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                ...
                <div class="detail-group">
                    ...
                    <p class="detail-value font-semibold text-blue-700 text-lg">
                        #{{ $escala->vuelo->IdVuelo ?? 'N/A' }}
                    </p>
                    <p class="text-sm text-gray-600">
                        Ruta: {{ $escala->vuelo->aeropuertoOrigen->NombreAeropuerto ?? 'N/A' }} **→** {{ $escala->vuelo->aeropuertoDestino->NombreAeropuerto ?? 'N/A' }}
                    </p>
                </div>
                ...
                <div class="detail-group">
                    ...
                    <p class="detail-value text-lg">
                        **{{ $escala->aeropuerto->NombreAeropuerto ?? 'N/A' }}**
                    </p>
                    <p class="text-sm text-gray-600">
                        Código: {{ $escala->aeropuerto->IdAeropuerto ?? 'N/A' }}
                    </p>
                </div>
                ...
                <div class="detail-group">
                    ...
                    <p class="detail-value text-xl font-bold text-green-700">
                        {{ \Carbon\Carbon::parse($escala->HoraLlegada)->format('H:i') }} hrs
                    </p>
                </div>
                ...
                <div class="detail-group">
                    ...
                    <p class="detail-value text-xl font-bold text-red-700">
                        {{ \Carbon\Carbon::parse($escala->HoraSalida)->format('H:i') }} hrs
                    </p>
                </div>
                ...
                <div class="detail-group">
                    ...
                    @endphp
                    <span class="px-3 py-1 rounded-full text-sm font-semibold {{ $statusClass[$escala->Estado] ?? $statusClass['default'] }}">
                        {{ $escala->Estado }}
                    </span>
                </div>
            ...
            <div class="mt-8 pt-4 border-t border-gray-200 flex justify-end">
                 <a href="{{ route('escala.index') }}" class="material-btn material-btn-secondary">
                    <i class="material-icons text-sm mr-2">arrow_back</i>
                    Volver
                </a>
            </div>
