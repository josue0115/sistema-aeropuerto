                ...
                <div class="card-body">
                    <form action="{{ route('facturas.update', $factura[0]->idFactura) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('idBoleto') is-invalid @enderror" id="idBoleto" name="idBoleto" value="{{ old('idBoleto', $factura[0]->idBoleto) }}">
                            @error('idBoleto')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('FechaEmision') is-invalid @enderror" id="FechaEmision" name="FechaEmision" value="{{ old('FechaEmision', $factura[0]->FechaEmision ? \Carbon\Carbon::parse($factura[0]->FechaEmision)->format('Y-m-d\TH:i') : '') }}">
                            @error('FechaEmision')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('monto') is-invalid @enderror" id="monto" name="monto" value="{{ old('monto', $factura[0]->monto) }}">
                            @error('monto')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('impuesto') is-invalid @enderror" id="impuesto" name="impuesto" value="{{ old('impuesto', $factura[0]->impuesto) }}">
                            @error('impuesto')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('MontoTotal') is-invalid @enderror" id="MontoTotal" name="MontoTotal" value="{{ old('MontoTotal', $factura[0]->MontoTotal) }}" readonly>
                            @error('MontoTotal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
