...
@section('page-title', 'Detalles de Factura - ' . $factura[0]->idFactura)
    ...
    <div class="material-card shadow-xl rounded-lg max-w-4xl w-full border-t-4 border-teal-600 mt-8">
        <div class="p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-teal-50 p-4 rounded-lg border border-teal-200">
                    ...
                    <div class="detail-group border-b-0 pb-0">
                        ...
                        <p class="detail-value **text-xl** font-bold text-gray-800">
                            {{ \Carbon\Carbon::parse($factura[0]->FechaEmision)->format('d/m/Y H:i') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="detail-group">
                        ...
                        <p class="detail-value **text-xl** font-semibold text-gray-900">
                            {{ number_format($factura[0]->monto, 2) }}
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100">
                    <div class="detail-group">
                        ...
                        <p class="detail-value **text-xl** font-semibold text-gray-900">
                            {{ number_format($factura[0]->impuesto, 2) }}
                        </p>
                    </div>
                    ...
                    <div class="detail-group">
                        ...
                        <p class="detail-value **text-3xl** font-extrabold text-teal-700">
                            {{ number_format($factura[0]->MontoTotal, 2) }}
                        </p>
                    </div>
                </div>
            ...
            <div class="mt-8 pt-4 border-t border-gray-200 flex justify-end space-x-3">
                 ...
                 <a href="{{ route('facturas.index') }}" class="material-btn material-btn-secondary">
                    <i class="material-icons text-sm mr-2">arrow_back</i>
                    Volver al Listado
                </a>

                <form action="{{ route('facturas.destroy', $factura[0]->idFactura) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar esta factura?');" class="inline-block">
                    @csrf
                    @method('DELETE')
