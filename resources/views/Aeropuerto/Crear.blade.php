        ...
        <div class="modal-content">
          <form method="POST" action="{{ route('aeropuerto.store') }}">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label>ID</label>
                    <input type="text" name="IdAeropuerto" class="form-control" required maxlength="20">
                </div>
                <div class="mb-3">
                    <label>Nombre</label>
                    <input type="text" name="NombreAeropuerto" class="form-control" required maxlength="50">
                </div>
                <div class="mb-3">
                    <label>País</label>
                    <input type="text" name="Pais" class="form-control" maxlength="10">
                </div>
                <div class="mb-3">
                    <label>Ciudad</label>
