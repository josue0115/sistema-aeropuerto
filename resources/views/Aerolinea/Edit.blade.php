    ...
    <div class="modal fade show" id="modalEditar" tabindex="-1" aria-labelledby="modalEditarLabel" aria-hidden="false" style="display: block;">
      <div class="modal-dialog">
        <div class="modal-content">
          <form method="POST" action="{{ route('aerolinea.update', $aerolinea->IdAerolinea) }}">
            @csrf
            @method('PUT')
            <div class="modal-header">
              <h5 class="modal-title" id="modalEditarLabel">Editar Aerolínea</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label>Nombre</label>
                    <input type="text" name="NombreAerolinea" class="form-control" value="{{ $aerolinea->NombreAerolinea }}" required>
                </div>
                <div class="mb-3">
                    <label>País</label>
                    <input type="text" name="Pais" class="form-control" value="{{ $aerolinea->Pais }}">
                </div>
                <div class="mb-3">
                    <label>Ciudad</label>
                    <input type="text" name="Ciudad" class="form-control" value="{{ $aerolinea->Ciudad }}">
                </div>
                <div class="mb-3">
                    <label>Estado</label>
