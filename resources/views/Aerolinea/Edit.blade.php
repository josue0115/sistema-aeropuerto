            ...
            <form method="POST" action="{{ route('aerolinea.update', $aerolinea->idAerolinea) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="Nombre" id="Nombre" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500" value="{{ $aerolinea->Nombre }}" required>
                        @error('Nombre')
