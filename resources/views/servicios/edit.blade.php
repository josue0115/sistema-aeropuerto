                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('idBoleto') is-invalid @enderror" id="idBoleto" name="idBoleto" required>
                                        ...
                                        @foreach($boletos ?? [] as $boleto)
                                            <option value="{{ $boleto->idBoleto }}" {{ old('idBoleto', $servicio[0]->idBoleto ?? '') == $boleto->idBoleto ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('Fecha') is-invalid @enderror" id="Fecha" name="Fecha" value="{{ old('Fecha', $servicio[0]->Fecha ? \Carbon\Carbon::parse($servicio[0]->Fecha)->format('Y-m-d\TH:i') : date('Y-m-d\TH:i')) }}" min="{{ date('Y-m-d\TH:i') }}">
                                    @error('Fecha')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('idTipoServicio') is-invalid @enderror" id="idTipoServicio" name="idTipoServicio" required>
                                        ...
                                        @foreach($tipoServicios ?? [] as $tipoServicio)
                                            <option value="{{ $tipoServicio->idTipoServicio }}" data-costo="{{ $tipoServicio->Costo }}" {{ old('idTipoServicio', $servicio[0]->idTipoServicio ?? '') == $tipoServicio->idTipoServicio ? 'selected' : '' }}>
                                                {{ $tipoServicio->Nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('Cantidad') is-invalid @enderror" id="Cantidad" name="Cantidad" value="{{ old('Cantidad', $servicio[0]->Cantidad ?? '') }}" min="0.01" required>
                                    @error('Cantidad')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="CostoTotal" name="CostoTotal" value="{{ old('CostoTotal', $servicio[0]->CostoTotal ?? '') }}" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('Estado') is-invalid @enderror" id="Estado" name="Estado" required>
                                        ...
                                        <option value="Activo" {{ old('Estado', $servicio[0]->Estado ?? '') == 'Activo' ? 'selected' : '' }}>Activo</option>
                                        <option value="Inactivo" {{ old('Estado', $servicio[0]->Estado ?? '') == 'Inactivo' ? 'selected' : '' }}>Inactivo</option>
                                        <option value="Pendiente" {{ old('Estado', $servicio[0]->Estado ?? '') == 'Pendiente' ? 'selected' : '' }}>Pendiente</option>
                                    </select>
                                    @error('Estado')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
