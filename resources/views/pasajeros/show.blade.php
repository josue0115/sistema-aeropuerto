...
@section('page-title', 'Detalles del Pasajero - Sistema Aeropuerto')
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-gray-600 text-lg">Información completa del pasajero #{{ $pasajero[0]->idPasajero }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 text-lg">
                ...
                <div>
                    <p class="mb-3">
                        ...
                        <span class="text-gray-900 font-mono bg-gray-100 px-2 py-0.5 rounded">{{ $pasajero[0]->idPasajero }}</span>
                    </p>
                    <p class="mb-3">
                        ...
                        <span class="text-gray-900">{{ $pasajero[0]->Nombre }}</span>
                    </p>
                    <p class="mb-3">
                        ...
                        <span class="text-gray-900">{{ $pasajero[0]->Apellido }}</span>
                    </p>
                </div>
                ...
                <div>
                    <p class="mb-3">
                        ...
                        <span class="text-gray-900">{{ $pasajero[0]->Pais }}</span>
                    </p>
                    <p class="mb-3">
                        ...
                        <span class="text-gray-900">{{ $pasajero[0]->TipoPasajero }}</span>
                    </p>
                    <p class="mb-3">
