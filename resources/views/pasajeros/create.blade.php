...
<div class="container mx-auto px-2 py-6">
    ...
    <div class="material-card">
      ...
      <div class="flex flex-row justify-center gap-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button type="submit" class="material-btn flex-none px-6" name="action" value="continue_to_boletos">
                <i class="material-icons text-sm mr-2">arrow_forward</i>
                Guardar y Continuar a Boletos
            </button>

            <a href="{{ route('pasajeros.index') }}" class="material-btn material-btn-secondary flex-none px-6">
