<?php $__env->startSection('page-title', 'Eliminar Aerolínea'); ?>
...
<div class="container mx-auto px-4 py-8 flex justify-center items-start min-h-[70vh]">
    ...
    <div class="material-card shadow-xl rounded-lg max-w-xl w-full border-t-4 border-red-600 mt-8">
        ...
        <form action="<?php echo e(route('aerolinea.destroy', $aerolinea->IdAerolinea)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-md border border-gray-200">
                    ...
                    <div class="detail-group">
                        ...
                        <p class="detail-value text-lg font-semibold text-gray-800"><?php echo e($aerolinea->IdAerolinea); ?></p>
                    </div>

                    <div class="detail-group">
                        <label class="detail-label text-sm"><i class="material-icons text-xs mr-1 align-middle">business</i> Nombre Comercial</label>
                        <p class="detail-value text-lg font-semibold text-gray-800"><?php echo e($aerolinea->NombreAerolinea); ?></p>
                    </div>

                    <div class="detail-group">
                        <label class="detail-label text-sm"><i class="material-icons text-xs mr-1 align-middle">flight</i> Código IATA</label>
                        <p class="detail-value text-lg font-semibold text-gray-800"><?php echo e($aerolinea->IATA); ?></p>
                    </div>
                    
                    <div class="detail-group">
                        <label class="detail-label text-sm"><i class="material-icons text-xs mr-1 align-middle">location_city</i> Ciudad Base</label>
                        <p class="detail-value text-lg font-semibold text-gray-800"><?php echo e($aerolinea->Ciudad); ?></p>
                    </div>
                    ...
                    <div class="detail-group col-span-2">
                        ...
                        <p class="detail-value text-lg font-semibold text-gray-800"><?php echo e($aerolinea->Pais); ?></p>
                    </div>
                    
                    <div class="detail-group col-span-2">
                        <label class="detail-label text-sm"><i class="material-icons text-xs mr-1 align-middle">toggle_on</i> Estado</label>
                        <p class="detail-value text-lg font-semibold text-gray-800"><?php echo e($aerolinea->Estado); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/Aerolinea/Delete.blade.php ENDPATH**/ ?>