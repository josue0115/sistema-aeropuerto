<?php $__env->startSection('page-title', 'Lista de Vuelos'); ?>
            ...
            <div class="material-card">
                ...
                <div class="card-body" style="padding: 0;">
                    <table id="tablaVuelos" class="table table-striped w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $vuelos ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vuelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($vuelo->IdVuelo); ?></td>
                                    <td>
                                        <span style="font-weight: 500;"><?php echo e(data_get($vuelo, 'avion.Placa', 'N/A')); ?></span>
                                    </td>
                                    <td><?php echo e(data_get($vuelo, 'aeropuertoOrigen.NombreAeropuerto', 'N/A')); ?></td>
                                    <td><?php echo e(data_get($vuelo, 'aeropuertoDestino.NombreAeropuerto', 'N/A')); ?></td>
                                    <td style="white-space: nowrap;"><?php echo e(\Carbon\Carbon::parse($vuelo->FechaSalida)->format('d/m/Y H:i')); ?></td>
                                    <td style="white-space: nowrap;"><?php echo e($vuelo->FechaLlegada ? \Carbon\Carbon::parse($vuelo->FechaLlegada)->format('d/m/Y H:i') : 'N/A'); ?></td>
                                    <td style="font-weight: 600; color: var(--color-primary); font-size: 1.1rem; white-space: nowrap;">
                                        Q<?php echo e(number_format($vuelo->Precio, 2)); ?>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="<?php echo e(route('vuelo.show', $vuelo->IdVuelo)); ?>" class="material-btn material-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">visibility</i>
                                            </a>
                                            
                                            <?php if(auth()->user()->role === 'operador'): ?>                                            
                                            <a href="<?php echo e(route('vuelo.edit', $vuelo->IdVuelo)); ?>" class="material-btn" style="background: linear-gradient(135deg, #d69e2e, #ed8936); color: white; padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">edit</i>
                                            </a>
                                            
                                            <a href="<?php echo e(route('vuelo.delete', $vuelo->IdVuelo)); ?>" class="material-btn" style="background: linear-gradient(135deg, #e53e3e, #f56565); color: white; padding: 6px 12px; font-size: 0.8rem; border: none;" onclick="return confirm('¿Está seguro de eliminar este vuelo?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/Vuelo/Listar.blade.php ENDPATH**/ ?>