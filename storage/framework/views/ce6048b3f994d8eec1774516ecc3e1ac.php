<?php $__env->startSection('page-title', 'Detalles del Equipaje - Sistema Aeropuerto'); ?>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-gray-600 text-lg">Información completa del equipaje #<?php echo e($equipaje->idEquipaje); ?></p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-8 text-base">
                ...
                <div>
                    ...
                    <div class="detail-item mb-3">
                        ...
                        <span class="text-gray-900 font-mono bg-gray-100 px-2 py-0.5 rounded"><?php echo e($equipaje->idEquipaje); ?></span>
                    </div>
                    ...
                    <div class="detail-item mb-3">
                        ...
                        <span class="text-gray-900 flex items-center">
                            ...
                            <?php echo e($equipaje->Dimensiones); ?>
                    ...
                    <div class="detail-item mb-3">
                        ...
                        <span class="text-gray-900 flex items-center">
                            ...
                            <?php echo e(number_format($equipaje->Peso, 2)); ?> kg
                        </span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="detail-item mb-3">
                        ...
                        <span class="text-gray-900 font-medium">$<?php echo e(number_format($equipaje->Costo, 2)); ?></span>
                    </div>

                    <div class="detail-item mb-3">
                        <strong class="font-semibold text-gray-700 block">Costo Extra:</strong> 
                        <span class="text-orange-600 font-medium">+ $<?php echo e(number_format($equipaje->CostoExtra, 2)); ?></span>
                    </div>
                    ...
                    <div class="detail-item mb-4">
                        ...
                        <span class="text-blue-900 font-extrabold text-xl">
                            $<?php echo e(number_format($equipaje->Monto, 2)); ?>
                    ...
                    <div class="detail-item mb-3">
                        ...
                        ?>
                        <span class="px-3 py-1 text-sm font-semibold rounded-full <?php echo e($color); ?>"><?php echo e($estado); ?></span>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/equipajes/show.blade.php ENDPATH**/ ?>