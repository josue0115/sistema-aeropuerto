<?php $__env->startSection('page-title', 'Lista de Aerolíneas'); ?>
            ...
            <div class="material-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-light)); color: white; border: none; padding: 24px;">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="<?php echo e(route('aerolinea.create')); ?>" class="material-btn material-btn-primary">
                ...
                <div class="card-body" style="padding: 0;">
                    <table id="tablaAerolineas" class="table table-striped w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $aerolineas ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aero): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($aero->IdAerolinea); ?></td>
                                <td style="font-weight: 600; color: var(--color-primary);"><?php echo e($aero->NombreAerolinea); ?></td>
                                <td style="font-weight: 600; color: #333; text-align: center;">
                                    <span class="badge" style="background-color: var(--color-accent); color: #333; padding: 6px 10px;">
                                        <?php echo e($aero->IATA); ?>

                                    </span>
                                </td>
                                <td><?php echo e($aero->Ciudad); ?>, <?php echo e($aero->Pais); ?></td>
                                <td>
                                    <?php
                                ...
                                <td style="white-space: nowrap;">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('aerolinea.show', $aero)); ?>" class="material-btn material-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                            <i class="bi bi-eye" style="font-size: 1rem;"></i>
                                        </a>
                                        
                                        <?php if(auth()->user()->role !== 'admin'): ?>
                                        
                                        <a href="<?php echo e(route('aerolinea.edit', $aero)); ?>" class="material-btn" style="background: linear-gradient(135deg, #d69e2e, #ed8936); color: white; padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                            <i class="bi bi-pencil-square" style="font-size: 1rem;"></i>
                                        </a>
                                        
                                        <a href="<?php echo e(route('aerolinea.delete', $aero)); ?>" class="material-btn" style="background: linear-gradient(135deg, #e53e3e, #f56565); color: white; padding: 6px 12px; font-size: 0.8rem; border: none;" onclick="return confirm('¿Está seguro de eliminar esta aerolínea?')">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/Aerolinea/Listar.blade.php ENDPATH**/ ?>