<?php $__env->startSection('page-title', 'Editar Asiento - Sistema Aeropuerto'); ?>
...
<div class="container mx-auto px-4 py-8">
            ...
            <div class="p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600"><?php echo e($asiento[0]->NumeroAsiento); ?> - <?php echo e($asiento[0]->Clase); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Vuelo #<?php echo e($asiento[0]->idVuelo); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="material-card">
        <div class="p-6">
            <form method="POST" action="<?php echo e(route('asientos.update', $asiento[0]->idAsiento)); ?>" x-data="seatSelection" x-init="init()">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="idAsiento" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-500" value="<?php echo e($asiento[0]->idAsiento); ?>" readonly>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="NumeroAsiento" id="NumeroAsiento" class="flex-1 px-3 py-2 border border-gray-300 rounded-md bg-gray-50 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 <?php $__errorArgs = ['NumeroAsiento'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('NumeroAsiento', $asiento[0]->NumeroAsiento)); ?>" readonly required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="IdVuelo" id="IdVuelo" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500" required>
                            ...
                            <?php $__currentLoopData = $vuelos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vuelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($vuelo->IdVuelo); ?>" <?php echo e(old('IdVuelo', $asiento[0]->idVuelo) == $vuelo->IdVuelo ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="Clase" id="Clase" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 focus:outline-none focus:ring-2 focus:ring-cyan-500" value="<?php echo e(old('Clase', $asiento[0]->Clase)); ?>" readonly>
                    ...
                    <div>
                        ...
                        <select name="Estado" id="Estado" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500" required>
                            ...
                            <option value="Disponible" <?php echo e(old('Estado', $asiento[0]->Estado) == 'Disponible' ? 'selected' : ''); ?>>Disponible</option>
                            <option value="Ocupado" <?php echo e(old('Estado', $asiento[0]->Estado) == 'Ocupado' ? 'selected' : ''); ?>>Ocupado</option>
                            <option value="Reservado" <?php echo e(old('Estado', $asiento[0]->Estado) == 'Reservado' ? 'selected' : ''); ?>>Reservado</option>
                            <option value="Mantenimiento" <?php echo e(old('Estado', $asiento[0]->Estado) == 'Mantenimiento' ? 'selected' : ''); ?>>Mantenimiento</option>
                        </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/asientos/edit.blade.php ENDPATH**/ ?>