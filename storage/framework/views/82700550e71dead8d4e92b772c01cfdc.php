<?php $__env->startSection('page-title', 'Lista de Pasajeros'); ?>
            ...
            <div class="material-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-light)); color: white; border: none; padding: 24px;">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="<?php echo e(route('pasajeros.create')); ?>" class="material-btn material-btn-primary">
                ...
                <div class="card-body" style="padding: 0;">
                    ...
                    <table id="tablaPasajeros" class="table table-striped w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $pasajeros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pasajero): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($pasajero->idPasajero); ?></td>
                                    <td style="font-weight: 600; color: var(--color-primary);">
                                        <?php echo e($pasajero->Nombre); ?> <?php echo e($pasajero->Apellido); ?>

                                    </td>
                                    <td><?php echo e($pasajero->Pais); ?></td>
                                    <td>
                                        <?php
                                        ...
                                        ?>
                                        <span class="badge" style="background-color: <?php echo e($tipoColor); ?>; color: white; padding: 6px 12px; border-radius: 20px; font-weight: 500;">
                                            <?php echo e($pasajero->TipoPasajero ?? 'N/A'); ?>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge" style="background: <?php echo e($estadoStyles); ?>; color: white; padding: 6px 12px; border-radius: 20px; font-weight: 500;">
                                            <?php echo e($pasajero->Estado ?? 'N/A'); ?>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="<?php echo e(route('pasajeros.show', $pasajero->idPasajero)); ?>" class="material-btn material-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">visibility</i>
                                            </a>
                                            
                                            <?php if(auth()->user()->role === 'operador'): ?>
                                            
                                            <a href="<?php echo e(route('pasajeros.edit', $pasajero->idPasajero)); ?>" class="material-btn" style="background: linear-gradient(135deg, var(--color-warning-dark), #ed8936); color: white; padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">edit</i>
                                            </a>
                                            
                                            <form action="<?php echo e(route('pasajeros.destroy', $pasajero->idPasajero)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/pasajeros/index.blade.php ENDPATH**/ ?>