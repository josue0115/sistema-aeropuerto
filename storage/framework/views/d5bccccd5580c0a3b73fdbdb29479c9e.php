<?php $__env->startSection('page-title', 'Lista de Personal'); ?>
            ...
            <div class="material-card">
                <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-light)); color: white; border: none; padding: 24px;">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="<?php echo e(route('personal.create')); ?>" class="material-btn material-btn-primary">
                            ...
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route('personal.show', $p->IdPersonal)); ?>" class="material-btn material-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                            <i class="material-icons" style="font-size: 1rem;">visibility</i>
                                        </a>

                                        <?php if(auth()->user()->role !== 'admin'): ?>
                                        
                                        <a href="<?php echo e(route('personal.edit', $p->IdPersonal)); ?>" class="material-btn" style="background: linear-gradient(135deg, var(--color-secondary), var(--color-accent)); color: white; padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                            <i class="material-icons" style="font-size: 1rem;">edit</i>
                                        </a>
                                        
                                        <a href="<?php echo e(route('personal.delete', $p->IdPersonal)); ?>"
                                            class="material-btn"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/Personal/Listar.blade.php ENDPATH**/ ?>