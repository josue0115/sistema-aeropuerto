<?php $__env->startSection('page-title', 'Crear Pasajeros - Sistema Aeropuerto'); ?>
...
<div class="container mx-auto px-2 py-6">
    ...
    <div class="mb-1">
        <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex space-x-3">
                <a href="<?php echo e(route('vuelos.disponibles')); ?>" class="material-btn material-btn-secondary">
                    <i class="material-icons text-sm mr-2">arrow_back</i>
                    Volver a Vuelos
                </a> 
                <?php if(in_array(auth()->user()->role, ['operador'])): ?>
                <a href="<?php echo e(route('pasajeros.index')); ?>" class="material-btn material-btn-secondary">
    ...
    <div class="material-card">
        <div class="p-6">
            <form action="<?php echo e(route('pasajeros.store')); ?>" method="POST" id="pasajeros-form">
                <?php echo csrf_field(); ?>
                <div id="pasajeros-container">
                    <!-- Los formularios de pasajeros se generarán aquí dinámicamente -->
                    <input type="hidden" name="pasajeros[0][idPasajero]" value="<?php echo e(old('pasajeros.0.idPasajero', 1)); ?>">
                </div>
      ...
      <div class="flex flex-row justify-center gap-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <a href="<?php echo e(route('pasajeros.index')); ?>" class="material-btn material-btn-secondary flex-1 justify-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/pasajeros/create.blade.php ENDPATH**/ ?>