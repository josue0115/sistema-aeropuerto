<?php $__env->startSection('page-title', 'Reporte de Boletos Facturados'); ?>
        ...
        <div class="col-12">
            <div class="material-card">
                ...
                <div class="card-body" style="padding: 24px;">
                    ...
                    <form method="POST" action="<?php echo e(route('reportes.boletos-facturados.generar')); ?>" class="p-4 rounded-lg mb-5" style="background-color: var(--color-background-light); border: 1px solid #dee2e6;">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3 align-items-end">
                            <div class="col-md-3">
                                <label for="fecha_inicio" class="form-label text-sm font-weight-bold text-secondary mb-1">Fecha Inicio</label>
                                <input type="date" id="fecha_inicio" name="fecha_inicio" value="<?php echo e(old('fecha_inicio', $fechaInicio ?? date('Y-m-d', strtotime('-30 days')))); ?>"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" id="fecha_fin" name="fecha_fin" value="<?php echo e(old('fecha_fin', $fechaFin ?? date('Y-m-d'))); ?>"
                                    class="form-control" required style="border: 1px solid #ced4da;">
                            </div>
                    ...
                    <?php if(isset($reporteFacturados)): ?>
                        
                        <?php if($reporteFacturados->count() > 0): ?>
                            <div class="mt-4 text-sm bg-light p-4 rounded-lg mb-4" style="border: 1px dashed #ced4da;">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <span class="badge bg-secondary"><?php echo e($reporteFacturados->count()); ?></span>
                                    </div>
                                    <div class="col-md-4">
                                        <strong style="color: var(--color-primary);">Período:</strong> 
                                        <span class="badge bg-secondary"><?php echo e(\Carbon\Carbon::parse($fechaInicio)->format('d/m/Y')); ?> - <?php echo e(\Carbon\Carbon::parse($fechaFin)->format('d/m/Y')); ?></span>
                                    </div>
                                    <div class="col-md-4 text-md-end">
                                        ...
                                        <span class="badge" style="background-color: var(--color-financial); font-size: 1.1rem; font-weight: 700;">
                                            $<?php echo e(number_format($reporteFacturados->sum('Precio'), 2)); ?>
                        ...
                        <div class="table-scroll-container">
                            <table class="report-table table table-hover w-100 mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $reporteFacturados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $boleto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="font-weight-bold" style="color: var(--color-primary);"><?php echo e($boleto->IdBoleto); ?></td>
                                            <td><i class="material-icons" style="font-size: 1rem; vertical-align: middle; margin-right: 4px;">person</i> <?php echo e($boleto->Nombre); ?> <?php echo e($boleto->Apellido); ?></td>
                                            <td><i class="material-icons" style="font-size: 1rem; vertical-align: middle; margin-right: 4px; color: var(--color-text-muted);">flight_takeoff</i> Vuelo **<?php echo e($boleto->IdVuelo); ?>**</td>
                                            <td><?php echo e(\Carbon\Carbon::parse($boleto->FechaCompra)->format('d/m/Y H:i')); ?></td>
                                            <td class="text-end font-weight-bold" style="color: var(--color-financial); font-size: 1rem;">$<?php echo e(number_format($boleto->Precio, 2)); ?></td>
                                        </tr>
...
function exportFacturados() {
    ...
    const url = `<?php echo e(route('reportes.boletos-facturados.exportar')); ?>?fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}`;
    window.location.href = url;
}
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/reportes/boletos-facturados.blade.php ENDPATH**/ ?>