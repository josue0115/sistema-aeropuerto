<?php $__env->startSection('page-title', 'Lista de Equipajes'); ?>
            ...
            <div class="material-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-light)); color: white; border: none; padding: 24px;">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="<?php echo e(route('equipajes.create')); ?>" class="material-btn material-btn-primary">
                ...
                <div class="card-body" style="padding: 0;">
                    ...
                    <table id="tablaEquipajes" class="table table-striped w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $equipajes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipaje): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td style="font-weight: 600; color: var(--color-primary);"><?php echo e($equipaje->idEquipaje); ?></td>
                                    <td>
                                        <span style="font-weight: 500; color: var(--color-text-muted);">
                                            Boleto #<?php echo e($equipaje->idBoleto); ?>

                                        </span>
                                    </td>
                                    <td style="font-weight: 600; color: var(--color-success);">
                                        Q<?php echo e(number_format($equipaje->Costo ?? 0, 2)); ?>

                                    </td>
                                    <td>
                                        <span class="badge" style="background-color: #f0f0f0; color: #333; font-weight: 500;">
                                            <?php echo e($equipaje->Dimensiones ?? 'N/A'); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span style="font-weight: 600;">
                                            <?php echo e($equipaje->Peso ?? '0.0'); ?> kg
                                        </span>
                                    </td>
                                    <td style="font-weight: 600; color: var(--color-warning);">
                                        Q<?php echo e(number_format($equipaje->CostoExtra ?? 0, 2)); ?>

                                    </td>
                                    <td style="font-weight: 700; color: var(--color-primary); font-size: 1.15rem;">
                                        Q<?php echo e(number_format($equipaje->MontoTotal ?? 0, 2)); ?>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge" style="background: <?php echo e($estadoStyles); ?>; color: white; padding: 6px 12px; border-radius: 20px; font-weight: 500;">
                                            <?php echo e($equipaje->Estado ?? 'N/A'); ?>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="<?php echo e(route('equipajes.show', $equipaje->idEquipaje)); ?>" class="material-btn material-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">visibility</i>
                                            </a>
                                            
                                            <?php if(auth()->user()->role === 'operador'): ?>
                                            
                                            <a href="<?php echo e(route('equipajes.edit', $equipaje->idEquipaje)); ?>" class="material-btn" style="background: linear-gradient(135deg, var(--color-warning), #ed8936); color: white; padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">edit</i>
                                            </a>
                                            
                                            <form action="<?php echo e(route('equipajes.destroy', $equipaje->idEquipaje)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/equipajes/index.blade.php ENDPATH**/ ?>