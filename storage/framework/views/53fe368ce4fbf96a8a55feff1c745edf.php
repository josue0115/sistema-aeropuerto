<?php $__env->startSection('page-title', 'Lista de Mantenimientos'); ?>
            ...
            <div class="material-card">
                <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-light)); color: white; border: none; padding: 24px;">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('mantenimiento.create')); ?>" class="material-btn material-btn-primary">
                ...
                <div class="card-body" style="padding: 0;">
                    <table id="tablaMantenimientos" class="table table-striped w-100">
                        ...
                        <tbody>
                            ...
                            <?php if(is_null($mantenimiento) || is_null($mantenimiento->Id_mantenimiento) || empty($mantenimiento->Id_mantenimiento)): ?>
                                <?php continue; ?>
                            <?php endif; ?>
                            <tr>
                                <td><?php echo e($mantenimiento->Id_mantenimiento); ?></td>
                                <td style="font-weight: 500;">
                                    <?php echo e($mantenimiento->avion->Placa ?? 'N/A'); ?> 
                                    <span style="color: var(--color-text-muted); font-size: 0.85rem;">(<?php echo e($mantenimiento->avion->IdAvion ?? 'N/A'); ?>)</span>
                                </td>
                                <td><?php echo e($mantenimiento->personal->Nombre ?? 'N/A'); ?> <?php echo e($mantenimiento->personal->Apellido ?? 'N/A'); ?></td>
                                <td><?php echo e($mantenimiento->FechaIngreso ? \Carbon\Carbon::parse($mantenimiento->FechaIngreso)->format('d/m/Y') : 'N/A'); ?></td>
                                <td><?php echo e($mantenimiento->FechaSalida ? \Carbon\Carbon::parse($mantenimiento->FechaSalida)->format('d/m/Y') : 'N/A'); ?></td>
                                <td>
                                    <?php
                                        $tipo = $mantenimiento->Tipo ?? 'General';
                                        $color = ($tipo == 'Preventivo') ? '#00BCD4' : (($tipo == 'Correctivo') ? '#E53E3E' : '#718096');
                                    ?>
                                    <span class="badge" style="background-color: <?php echo e($color); ?>; color: white; padding: 6px 12px; border-radius: 20px; font-weight: 500;">
                                        <?php echo e($tipo); ?>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <span class="badge" style="background: <?php echo e($color); ?>; color: white; padding: 6px 12px; border-radius: 20px; font-weight: 500;">
                                        <?php echo e($estado); ?>

                                    </span>
                                </td>
                                <td style="font-weight: 600; color: var(--color-danger); font-size: 1.1rem; white-space: nowrap;">
                                    Q<?php echo e(number_format(($mantenimiento->Costo ?? 0) + ($mantenimiento->CostoExtra ?? 0), 2)); ?>

                                </td>
                                <td style="white-space: nowrap;">
                                    <div class="btn-group" role="group">
                                        
                                        <a href="<?php echo e(route('mantenimiento.show', $mantenimiento)); ?>" class="material-btn material-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                            <i class="material-icons" style="font-size: 1rem;">visibility</i>
                                        </a>

                                        
                                        <a href="<?php echo e(route('mantenimiento.edit', $mantenimiento)); ?>" class="material-btn" style="background: linear-gradient(135deg, var(--color-secondary), var(--color-accent)); color: white; padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                            <i class="material-icons" style="font-size: 1rem;">edit</i>
                                        </a>
                                        
                                        
                                        <form action="<?php echo e(route('mantenimiento.destroy', $mantenimiento)); ?>" method="POST" style="display: inline;">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/Mantenimiento/Listar.blade.php ENDPATH**/ ?>