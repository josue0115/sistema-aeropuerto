    ...
    <a href="<?php echo e(route('dashboard')); ?>">
        ...
        <span class="ms-2 text-xl font-semibold text-gray-800 tracking-tight"></span>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                   <?php if(in_array(auth()->user()->role, ['cliente', 'operador'])): ?>   
...
<?php endif; ?>
                ...
                <?php if(auth()->user()->role === 'admin' || auth()->user()->role === 'operador'): ?>
                    ...
                    <div x-data="{ open: false }" class="relative" style="padding-top: 1.25rem; padding-bottom: 0.5rem; margin-left: 1rem;">
                        <button 
                            ...
                            <?php echo e(__('Operaciones / Vuelos')); ?>
                        ...
                        <div x-show="open"
                            ...
                            <div class="p-3 space-y-2 max-h-50 overflow-y-auto scroll-custom">
                                <!-- Vuelos -->
                                <a href="<?php echo e(route('vuelos.index')); ?>" 
                                ...
                                <!-- Escalas -->
                                <a href="<?php echo e(route('escala.index')); ?>" 
                                ...
                                <!-- Horarios -->
                                <a href="<?php echo e(route('horario.listar')); ?>" 
                                ...
                                <!-- Aviones -->
                                <a href="<?php echo e(route('avion.listar')); ?>" 
                                ...
                                <!-- Aeropuertos -->
                                <a href="<?php echo e(route('aeropuertos.index')); ?>" 
                                ...
                                <!-- Aerolíneas -->
                                <a href="<?php echo e(route('aerolineas.index')); ?>" 
                                ...
                                <!-- Asientos -->
                                <a href="<?php echo e(route('asientos.index')); ?>" 
                    ...
                    <div x-data="{ open: false }" class="relative" style="padding-top: 1.25rem; padding-bottom: 0.5rem; margin-left: 1rem;">
                        <button
                            ...
                            class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
                            :class="{ 'border-gray-300 text-gray-700': open }">
                            <?php echo e(__('Pasajeros / Reservas')); ?>
                        ...
                        <div x-show="open"
                            ...
                            <div class="p-3 space-y-2 max-h-90 overflow-y-auto scroll-custom">
                                <!-- Vuelos -->
                                <a href="<?php echo e(route('pasajeros.index')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-blue-50 transition group">
                                ...
                                <!-- boletos -->
                                <a href="<?php echo e(route('boletos.index')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-green-50 transition group">
                                    <div style="width: 40px;" class=" h-10 bg-green-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-green-200 transition flex-shrink-0">
                                ...
                                <!-- Equipaje -->
                                <a href="<?php echo e(route('equipajes.index')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-orange-50 transition group">
                                    <div style="width: 40px;" class=" h-10 bg-orange-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-orange-200 transition flex-shrink-0">
                                ...
                                <!-- Historila de vuelos -->
                                <a href="<?php echo e(route('historial_vuelos.index')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-indigo-50 transition group">
                                    <div style="width: 40px;" class=" h-10 bg-indigo-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-indigo-200 transition flex-shrink-0">
                                        <i class="fas fa-building text-indigo-600"></i>
                                    </div>
                    ...
                    <div x-data="{ open: false }" class="relative" style="padding-top: 1.25rem; padding-bottom: 0.5rem; margin-left: 1rem;">
                        <button
                            ...
                            class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
                            :class="{ 'border-gray-300 text-gray-700': open }">
                            <?php echo e(__('Administrativao / Financiero')); ?>
                        ...
                        <div x-show="open"
                            ...
                            <div class="p-3 space-y-2 max-h-90 overflow-y-auto scroll-custom">
                                ...
                                <!-- Escalas -->
                                <a href="<?php echo e(route('pagos.index')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-purple-50 transition group">
                                    <div style="width: 40px;" class="h-10 bg-purple-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-purple-200 transition flex-shrink-0">
                    ...
                    <div x-data="{ open: false }" class="relative" style="padding-top: 1.25rem; padding-bottom: 0.5rem; margin-left: 1rem;">
                        <button
                            ...
                            class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
                            :class="{ 'border-gray-300 text-gray-700': open }">
                            <?php echo e(__('Personal / Mantenimiento')); ?>
                        ...
                        <div x-show="open"
                            ...
                            <div class="p-3 space-y-2 max-h-90 overflow-y-auto scroll-custom">
                                <!-- Vuelos -->
                                <a href="<?php echo e(route('personal.listar')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-blue-50 transition group">
                                    <div style="width: 40px;" class=" h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-blue-200 transition flex-shrink-0">
                                ...
                                <!-- Escalas -->
                                <a href="<?php echo e(route('mantenimiento.listar')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-purple-50 transition group">
                                    <div  style="width: 40px;" class=" h-10 bg-purple-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-purple-200 transition flex-shrink-0">
                    ...
                    <div x-data="{ open: false }" class="relative" style="padding-top: 1.25rem; padding-bottom: 0.5rem; margin-left: 1rem;">
                        ...
                        <div x-show="open"
                            ...
                            <div class="p-3 space-y-2 max-h-90 overflow-y-auto scroll-custom">
                                <!-- Reportes -->
                                <a href="<?php echo e(route('reportes.disponibilidad-boletos')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-blue-50 transition group">
                                    <div style="width: 40px;" class=" h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-blue-200 transition flex-shrink-0">
                                ...
                                <a href="<?php echo e(route('reportes.boletos-facturados')); ?>" 
                                    class="flex items-center p-3 rounded-lg hover:bg-blue-50 transition group">
                                    <div style="width: 40px;" class=" h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-blue-200 transition flex-shrink-0">
                  ...
                  <?php elseif(in_array(auth()->user()->role, ['cliente', 'operador'])): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown','data' => ['align' => 'right','width' => '48','class' => 'material-dropdown-content-wrapper']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['align' => 'right','width' => '48','class' => 'material-dropdown-content-wrapper']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('profile.edit'),'class' => 'material-dropdown-item']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.edit')),'class' => 'material-dropdown-item']); ?>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    ...
                    <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('logout'),'class' => 'material-dropdown-item text-red-600 hover:bg-red-50 hover:text-red-700','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'class' => 'material-dropdown-item text-red-600 hover:bg-red-50 hover:text-red-700','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();']); ?>
...
</div><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>