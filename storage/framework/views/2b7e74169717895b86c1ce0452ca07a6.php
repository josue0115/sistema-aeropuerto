<?php $__env->startSection('page-title', 'Crear Nuevo Personal'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="material-card shadow-xl rounded-lg max-w-4xl mx-auto">
        <div class="p-6">
            <form method="POST" action="<?php echo e(route('personal.store')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" required>
                            ...
                            <option value="Piloto" <?php echo e(old('Cargo') == 'Piloto' ? 'selected' : ''); ?>>Piloto</option>
                            <option value="Copiloto" <?php echo e(old('Cargo') == 'Copiloto' ? 'selected' : ''); ?>>Copiloto</option>
                            <option value="Azafata" <?php echo e(old('Cargo') == 'Azafata' ? 'selected' : ''); ?>>Azafata</option>
                            <option value="Mecánico" <?php echo e(old('Cargo') == 'Mecánico' ? 'selected' : ''); ?>>Mecánico</option>
                            <option value="Administrador" <?php echo e(old('Cargo') == 'Administrador' ? 'selected' : ''); ?>>Administrador</option>
                            <option value="Recepcionista" <?php echo e(old('Cargo') == 'Recepcionista' ? 'selected' : ''); ?>>Recepcionista</option>
                            <option value="Seguridad" <?php echo e(old('Cargo') == 'Seguridad' ? 'selected' : ''); ?>>Seguridad</option>
                            <option value="Limpieza" <?php echo e(old('Cargo') == 'Limpieza' ? 'selected' : ''); ?>>Limpieza</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="number" step="0.01" id="Salario" name="Salario" class="form-input w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed" value="<?php echo e(old('Salario')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?> w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" min="<?php echo e(date('Y-m-d')); ?>" value="<?php echo e(old('FechaIngreso', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="Nombre" name="Nombre" class="form-input <?php $__errorArgs = ['Nombre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" value="<?php echo e(old('Nombre')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="Apellido" name="Apellido" class="form-input <?php $__errorArgs = ['Apellido'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" value="<?php echo e(old('Apellido')); ?>" required>
...
unset($__errorArgs, $__bag); ?> w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" value="<?php echo e(old('Telefono')); ?>" required>
...
unset($__errorArgs, $__bag); ?> w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" value="<?php echo e(old('Correo')); ?>" required>
...
unset($__errorArgs, $__bag); ?> w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" value="<?php echo e(old('Direccion')); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/Personal/Create.blade.php ENDPATH**/ ?>