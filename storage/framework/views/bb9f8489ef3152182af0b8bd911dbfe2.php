<?php $__env->startSection('page-title', 'Lista de Asientos'); ?>
            ...
            <div class="material-card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--color-primary), var(--color-primary-light)); color: white; border: none; padding: 24px;">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="<?php echo e(route('asientos.create')); ?>" class="material-btn material-btn-primary">
                ...
                <div class="card-body" style="padding: 0;">
                    ...
                    <table id="tablaAsientos" class="table table-striped w-100">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $asientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asiento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($asiento->idAsiento); ?></td>
                                    <td><?php echo e($asiento->vuelo_info ?? 'N/A'); ?></td>
                                    <td style="font-weight: 600; color: var(--color-primary);"><?php echo e($asiento->NumeroAsiento); ?></td>
                                    <td>
                                        <?php
...
?>
                                        <span class="badge" style="background-color: <?php echo e($claseColor); ?>; color: white; padding: 6px 12px; border-radius: 20px; font-weight: 500;">
                                            <?php echo e($asiento->Clase ?: 'N/A'); ?>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="<?php echo e(route('asientos.show', $asiento->idAsiento)); ?>" class="material-btn material-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">visibility</i>
                                            </a>
                                            
                                            <?php if(auth()->user()->role === 'operador'): ?>
                                            
                                            <a href="<?php echo e(route('asientos.edit', $asiento->idAsiento)); ?>" class="material-btn" style="background: linear-gradient(135deg, var(--color-warning-dark), #ed8936); color: white; padding: 6px 12px; font-size: 0.8rem; margin-right: 4px;">
                                                <i class="material-icons" style="font-size: 1rem;">edit</i>
                                            </a> 
                                            
                                            <form action="<?php echo e(route('asientos.destroy', $asiento->idAsiento)); ?>" method="POST" style="display: inline;">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\repositorios\sistema-aeropuerto - copia (4)\resources\views/asientos/index.blade.php ENDPATH**/ ?>